		...
		<div id="wrapper">
			...
			<div id="main">
				...
				<section id="content" class="main">
					...
					<section>
						<h4 id="survey">
							<strong>2022.03.01~2022.03.07</strong> 기간동안의 수면 데이터 입니다
						</h4>
						...
						<div class="row">
							<div class="col-6 col-12-medium">
								...
								<ul>
									...
									<br>
									<h4>
										<strong>현재 도도동님의 평균심박수는 72로 정상범위이지만 평균에서 평균 이하로 갈 가능성이
											높습니다 적절한 운동이 필요합니다</strong>
									</h4>
									...
									<br>
									<h4>
										<strong>조용한 주택의 거실의 데시벨이 40정도입니다. 현재 코골이 이외의 특정한 소음이
											없기 때문에 현재의 소음 환경은 좋다고 평가할 수 있습니다.</strong>
									</h4>
								...
								<p>
									현재 도도동 님의 평균 심박 수는 72으로 26살 여성 기준 <u>정상 수치</u>입니다. 그러나 현재 전체 심박
									수 히스토리 분석 결과 자는 동안 급격히 심박 수가 튀는 경우가 보입니다 자연스러운 현상이기도 하지만 이 수치가
									많은 것으로 보아 스트레스를 받거나 잠에서 뒤척이는 경우가 많을 것으로 예상됩니다. 또한 최소 심박 수와 최대
									심박수의 차이가 많이 나기 때문에 이 부분에 유의하셔야 할 것 같습니다. <u>걱정될 정도의 수치는 보이지
										않습니다.</u> 그래도 건강한 심장을 위해 심폐 지구력을 키우는 유산소 운동을 추천해드립니다 한 달 정도는 수치를
									재면서 자보면서 심박 수 히스토리를 체크하세요
								</p>
		...
		<section>
			...
			<form method="post" action="#">
				<div class="row gtr-uniform">
					...
					<div class="col-4 col-12-small">
						<input type="radio" id="good" name="demo-priority"> <label for="good">만족</label>
					</div>
					<div class="col-4 col-12-small">
						<input type="radio" id="normal" name="demo-priority"> <label for="normal">보통</label>
					</div>
					<div class="col-4 col-12-small">
						<input type="radio" id="bad" name="demo-priority"> <label for="bad">불만족</label>
					</div>
					<div class="col-4 col-12-small">
						<input type="radio" id="verybad" name="demo-priority"> <label for="verybad">매우 불만족</label>
					</div>
