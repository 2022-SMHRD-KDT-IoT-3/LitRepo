		...
		<section id="content" class="main">
			<table>
				...
				<tr>
					<td>
					<div class="card" style="width: 18rem;">
						<a href="https://www.coupang.com/vp/products/4797132556?itemId=6153998527&vendorItemId=73450212697&sourceType=srp_product_ads&clickEventId=9515a7fb-013c-4b3c-aad0-9f19250efe97&korePlacement=15&koreSubPlacement=1&q=%EC%95%88%EB%8C%80&itemsCount=36&searchId=deac6104dfaa4c1a92680379c2d6ca40&rank=0&isAddedCart="><img src="./img_living/리빙안대.jpg" class="card-img-top" width="300px" height="220"></a>
						<div class="card-body">
				...
				<tr>
					<td>
						<div class="card" style="width: 18rem;">
							<a href="https://www.coupang.com/vp/products/5381078624?itemId=7992646530&vendorItemId=75281506604&sourceType=srp_product_ads&clickEventId=dec5873f-5746-4886-9452-518de3974150&korePlacement=15&koreSubPlacement=1&q=%EB%B0%94%EB%94%94%ED%95%84%EB%A1%9C%EC%9A%B0&itemsCount=36&searchId=49daf002df994d5f86a7010015b4f89b&rank=0&isAddedCart="><img src="./img_living/리빙바디필로우.jpg " class="card-img-top" width="300px" height="220"></a>
								<p class="card-text" style="text-align: center">바디필로우</p>
							</div>
					</td>
					<td>
						<div class="card" style="width: 18rem;">
							<a href="https://www.coupang.com/vp/products/6287026153?itemId=12935531344&vendorItemId=80199938635&q=%EC%9E%A0%EC%98%B7&itemsCount=36&searchId=12591285ebba4006b2fba3860c10765b&rank=1&isAddedCart="><img src="./img_living/리빙잠옷.jpg" class="card-img-top" width="300px" height="220"></a>
							<div class="card-body">
