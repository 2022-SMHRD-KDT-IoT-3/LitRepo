			...
			<table>
				<tr>
					<td>
						<div class="card" style="width: 18rem;">
							<!-- target="_blank" 완료 -->
							<a
								href="https://www.coupang.com/vp/products/4729986254?itemId=5992660161&vendorItemId=73290463344&sourceType=srp_product_ads&clickEventId=75db82da-eaf7-44a3-8636-29931a3b938b&korePlacement=15&koreSubPlacement=6&q=%EB%B2%A0%EA%B2%8C&itemsCount=36&searchId=4d5cc7272a244e81bd81517dc455c261&rank=5&isAddedCart="
								target="_blank"><img src="./img_living/리빙베게.jpg"
					...
					<td>
						<div class="card" style="width: 18rem;">
							<a
								href="https://www.coupang.com/vp/products/28730577?itemId=110289996&vendorItemId=3059609743&sourceType=srp_product_ads&clickEventId=f86b9edd-3802-4849-b9a1-1a3d9ba95e0d&korePlacement=15&koreSubPlacement=1&q=%EB%9D%BC%ED%85%8D%EC%8A%A4+%EB%A7%A4%ED%8A%B8%EB%A6%AC%EC%8A%A4&itemsCount=36&searchId=0724f824f797408fae8f21fa66a8f47e&rank=0&isAddedCart="
								target="_blank"><img src="./img_living/리빙매트리스.jpg"
								class="card-img-top" width="300px" height="220"></a>
							<div class="card-body">
				...
				<tr>
					<td>
						<div class="card" style="width: 18rem;">
							<a
								...
								target="_blank"><img src="./img_living/리빙안대.jpg"
								class="card-img-top" width="300px" height="220"></a>
							<div class="card-body">
					...
					<td>
						<div class="card" style="width: 18rem;">
							<a
								href="https://www.coupang.com/vp/products/2348099928?itemId=4072050680&vendorItemId=78408866734&sourceType=srp_product_ads&clickEventId=495bdc10-b66b-442f-b521-3524d28a4c94&korePlacement=15&koreSubPlacement=1&q=%EC%98%A8%EC%88%98%EB%A7%A4%ED%8A%B8&itemsCount=36&searchId=a8fcd655d7bd4552bc7afb97b65dccae&rank=0&isAddedCart="
								target="_blank"><img src="./img_living/리빙온수매트.png"
								class="card-img-top" width="300px" height="220"></a>
							<div class="card-body">
				...
				<tr>
					<td>
						<div class="card" style="width: 18rem;">
							<a
								href="https://www.coupang.com/vp/products/5381078624?itemId=7992646530&vendorItemId=75281506604&sourceType=srp_product_ads&clickEventId=dec5873f-5746-4886-9452-518de3974150&korePlacement=15&koreSubPlacement=1&q=%EB%B0%94%EB%94%94%ED%95%84%EB%A1%9C%EC%9A%B0&itemsCount=36&searchId=49daf002df994d5f86a7010015b4f89b&rank=0&isAddedCart="
								target="_blank"><img src="./img_living/리빙바디필로우.jpg "
								class="card-img-top" width="300px" height="220"></a>
					...
					<td>
						<div class="card" style="width: 18rem;">
							<a
								href="https://www.coupang.com/vp/products/6287026153?itemId=12935531344&vendorItemId=80199938635&q=%EC%9E%A0%EC%98%B7&itemsCount=36&searchId=12591285ebba4006b2fba3860c10765b&rank=1&isAddedCart="
								target="_blank"><img src="./img_living/리빙잠옷.jpg"
								class="card-img-top" width="300px" height="220"></a>
							<div class="card-body">
