			...
			<div id="main">
				<section id="content" class="main">
					<div class="col-6 col-12-medium">
						...
						<p style="text-align: center;">현재 '정정용'님은 사용자 평균에 비해 <u> 매우 좋은 수면환경</u>을 가지고 있습니다. 하루 7시간 이상의 수면시간을 가지는 것으로 보아 전체적인 수면 점수가 높게 나올 수 있었습니다.
						...
						<table class="physical">
							...
							<tr>
								<td colspan="4">인터벌 운동은 걷고 뛰고를 반복하는 운동으로 심폐지구력 향상에 탁월합니다.
									최대심박수까지 여러 번 도달하는 것을 목표로 합니다.</td>
							</tr>
