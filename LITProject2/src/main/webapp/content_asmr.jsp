	...
	<section id="content" class="main">
		<table>
			<tr>
				<td>
					<div class="card" style="width: 18rem;">
						<!-- target="_blank" 완료 -->
						<a href="https://www.youtube.com/watch?v=HrO74lj5QBs"
							target="_blank"><img src="./img_asmr/asmr비.jpg"
				...
				<td>
					<div class="card" style="width: 18rem;">
						<a href="https://www.youtube.com/watch?v=KKi2qiuZZWQ"
							target="_blank"><img src="./img_asmr/asmr바람.jpg"
							class="card-img-top" width="300px" height="220"></a>
						<div class="card-body">
			...
			<tr>
				<td>
					<div class="card" style="width: 18rem;">
						<a href="https://www.youtube.com/watch?v=6ZSbWQkIYsU"
							target="_blank"><img src="./img_asmr/asmr장작.jpg"
							class="card-img-top" width="300px" height="220"></a>
						<div class="card-body">
				...
				<td>
					<div class="card" style="width: 18rem;">
						<a href="https://www.youtube.com/watch?v=lYJ17n_oUkA"
							target="_blank"><img src="./img_asmr/asmr숲.jpg"
							class="card-img-top" width="300px" height="220"></a>
						<div class="card-body">
			...
			<tr>
				<td>
					<div class="card" style="width: 18rem;">
						<a href="https://www.youtube.com/watch?v=zp789sRyQKg"
							target="_blank"><img src="./img_asmr/asmr바다.jpg"
							class="card-img-top" width="300px" height="220"></a>
						<div class="card-body">
				...
				<td>
					<div class="card" style="width: 18rem;">
						<a href="https://www.youtube.com/watch?v=xym-gmq_rlw"
							target="_blank"><img src="./img_asmr/asmr카페.jpg"
							class="card-img-top" width="300px" height="220"></a>
						<div class="card-body">
