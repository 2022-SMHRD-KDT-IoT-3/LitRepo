		...
		<table>
			<tr align="center">
				<td><a id="bt" href="content_main.jsp">Main</a> <a id="bt"
					href="content_perfum.jsp">All</a> <a id="bt"
					href="perfume_시트러스.jsp">Citrus</a> <a id="bt"
					href="perfume_플로럴.jsp">Flower</a> <a id="bt" href="perfume_프루티.jsp">Fruit</a>
					<a id="bt" href="perfume_우디.jsp">Wood</a></td>
			</tr>
		</table>
		<!-- Content -->
				...
				<tr>
					<td>
						<div class="card" style="width: 18rem;">
							...
							<div class="card-body">
								<p class="card-text" style="text-align: center;">봄에 오는 달콤한
									프리지아</p>
							</div>
						</div>
					</td>
					...
					<td>
						<div class="card" style="width: 18rem;">
							<a
								...
								target="_blank"><img src="./img_perfume/플로럴장미.jpg"
								class="card-img-top" width="300px" height="220"></a>
							<div class="card-body">
					...
					<td>
						<div class="card" style="width: 18rem;">
							<a
								...
								target="_blank"><img src="./img_perfume/플로럴코튼.jpg"
								class="card-img-top" width="300px" height="220"></a>
							<div class="card-body">
								<p class="card-text" style="text-align: center;">안기고 싶은 포근한
									코튼향</p>
							</div>
						</div>
					</td>
					...
					<td>
						<div class="card" style="width: 18rem;">
							<a
								...
								class="card-img-top" width="300px" height="220"></a>
							<div class="card-body">
								<p class="card-text" style="text-align: center;">화사하고 깨끗한 웨딩
									부케</p>
							</div>
						</div>
					</td>
