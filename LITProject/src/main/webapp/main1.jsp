		...
		<header id="header" class="alt">
			...
			<div id="main">
				...
				<section id="first" class="main special">
					...
					<ul class="features">
						<li><svg xmlns="http://www.w3.org/2000/svg" width="80"
								height="80" fill="currentColor" class="bi bi-lightbulb"
								viewBox="0 0 16 16">
											<path
									d="M2 6a6 6 0 1 1 10.174 4.31c-.203.196-.359.4-.453.619l-.762 1.769A.5.5 0 0 1 10.5 13a.5.5 0 0 1 0 1 .5.5 0 0 1 0 1l-.224.447a1 1 0 0 1-.894.553H6.618a1 1 0 0 1-.894-.553L5.5 15a.5.5 0 0 1 0-1 .5.5 0 0 1 0-1 .5.5 0 0 1-.46-.302l-.761-1.77a1.964 1.964 0 0 0-.453-.618A5.984 5.984 0 0 1 2 6zm6-5a5 5 0 0 0-3.479 8.592c.263.254.514.564.676.941L5.83 12h4.342l.632-1.467c.162-.377.413-.687.676-.941A5 5 0 0 0 8 1z" />
										  </svg> <br>
							<h3>무드등 기능</h3>
							<p>맞춤 색 설정이 가능하며 상황에 따른 맞춤 색을 추천합니다. 카테고리는 공부, 독서, 파티 등 6가지로
								분류되어 있습니다</p> <br></li>
						<br>
						<li><svg xmlns="http://www.w3.org/2000/svg" width="75"
								height="75" fill="currentColor" class="bi bi-heart-pulse-fill"
								viewBox="0 0 16 16">
							...
							<h3>수면 히스토리 기록</h3>
							<p>사용자의 수면시 심박수, 데시벨을 측정하고 그래프 형태로 보여줍니다. 또한 수면시 온/습도 등을 측정하여
								사용자가 현재 환경을 확인할 수 있습니다.</p> <br></li>
						<br>
						<li><br> <svg xmlns="http://www.w3.org/2000/svg"
							...
							<p>7일간의 사용자 데이터를 취합하여 분석합니다. 수면 패턴 결과에 이상이 있으면 전문가 상담을
								연결해드립니다. 취합된 결과는 정기적으로 이메일로 받을 수 있습니다.</p> <br></li>
					</ul>
				...
				<section id="cta" class="main special">
					...
					<footer class="major">
						<ul class="actions special">
							<li><a href="generic.html" class="button primary">회원가입</a></li>
						</ul>
					</footer>
				</section>
